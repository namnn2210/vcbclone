    ...
    React.useCallback(() => {
      const showLocalNotification = async () => {
        ...
        await Notifications.scheduleNotificationAsync({
          content: {
            title: "Thông báo VCB",
            body: `Số dư TK VCB ${dataRoute.userInfo.accountNumber} -${dataRoute.amount} VND lúc ${formattedDate}. Số dư ${currentUser.amount.toLocaleString()}. Ref MBVCB.${billNumber}.765644.${dataRoute.contentSend}`,
            data: { data: 'goes here' },
          },
          trigger: null,
        });
